...
public class PluginUnappliableException extends RuntimeException {
  ...
  public PluginUnappliableException(String s) {
    super(s);
  }

  public PluginUnappliableException(String s, Throwable throwable) {
    super(s, throwable);
  }

  public PluginUnappliableException(Throwable throwable) {
    super(throwable);
  }
}